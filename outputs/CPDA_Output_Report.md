...
Insert your saved figures below (these PNGs are **not** present in this `outputs/` folder).
...
`[ Insert fig1_umap_clusters.png ]`

**Figure 2 — Cluster Behavioral Profiles (Radar)**

`[ Insert fig4_cluster_profiles.png ]`

**Figure 3 — Efficiency vs. Retention**

`[ Insert fig3_efficiency_vs_retention.png ]`
...
| L3 | **Platform latency confound** | `elapsed_time` derived from timestamp diffs reflects inter-event gaps, not true response latency. Device and network latency contribute noise. | `[ ✓ / — ]` |
...
The synthetic benchmark run (n=800, RANDOM_SEED=42) produced the reference values used in this template. Summarize how your real-data results compare below.

| Metric | Synthetic Benchmark | Your Real-Data Value | Direction |
|---|---:|---:|---|
